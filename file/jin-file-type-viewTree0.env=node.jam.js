$jin.klass({ '$jin.file.type.viewTree0': [ '$jin.file.type.tree' ] })

$jin.method({ '$jin.file.type.viewTree0.ext': function( ){
	this['$jin.file.type.tree.ext']
	return '.view0.tree'
}})

$jin.atom1.prop({ '$jin.file.type.viewTree0..dependList': {
...
$jin.atom1.prop.list({ '$jin.file.type.viewTree0..jsFiles': {
